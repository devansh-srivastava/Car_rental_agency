...
<body>
	...
	<section class="search">
		...
		<div id="fom">
			<form method="post">
			<h3 style="text-align:center; color: #000099; font-weight:bold; text-decoration:underline">Agency Login Area</h3>
				<table height="100" align="center">
					...
					<tr>
						<td><input type="submit" name="login" value="Login Here"></td>
						<td style="text-align:right;"><a href="signup_A.php">Sigup Here</a></td>
