				...
				<div class="box">
					...
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="form">
								...
								<p>
									...
									<input type="text" class="field size1" name="car_number" required />
								</p>
								<p>
									<span class="req">max 20 symbols</span>
					...
					<?php
							if(isset($_POST['send'])){
								...
								$qr = "INSERT INTO cars (image, car_name,car_type,hire_cost,capacity,car_number,status) 
													VALUES ('$image','$car_name','$car_type','$hire_cost','$capacity','$car_number','Available')";
								$res = $conn->query($qr);
								if($res === TRUE){
